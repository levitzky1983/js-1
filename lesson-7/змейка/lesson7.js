...
function startGame() {
    ...
    document.querySelector("#scoreId").innerText = score;
}
...
function move() {
    ...
    //alert(snake_coords);//преобразовали строку в массив
    ...
    //если вышел за экран, то появляешься с другой стороны
